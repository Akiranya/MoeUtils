...
public class StringConverter implements Converter {
    ...
    /**
     * This method mimics {@link ChatColor#translateAlternateColorCodes(char,
     * java.lang.String)} except that it changes the character
     * ChatColor.COLOR_CODE back to the text containing the character {@literal
     * &}.
     *
